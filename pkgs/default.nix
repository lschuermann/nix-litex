  ...
  makeFinal = self: name:
    let
      ...
      args = {
        ...
        # Technically, at build time this will have both the -pkg and
        # -test derivation present, which both provide the respective
        # Python package. This skips this check. All proper conflicts
        # should be found at build time of the -pkg derivation, whose
        # result this just reexposes.
